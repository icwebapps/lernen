...
import MultilineField from '../Form/MultilineField';
  ...
  render() {
    return ([
      ...
      <div key="modal-add-object" className="modal-add-object">
        ...
        <Field value={this.state.grade} name="" onChange={(name)=>this.setState({ grade: parseInt(name) })} />
        <div className="modal-separator"/>
        <div className="modal-label">Feedback</div>
        <MultilineField value={this.state.feedback} name="" onChange={(name)=>this.setState({ feedback: name })} />
        <div className="modal-separator"/>
